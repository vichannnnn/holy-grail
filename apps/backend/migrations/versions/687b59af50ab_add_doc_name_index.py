...
def upgrade():
    ...
    op.create_index(op.f("ix_library_document_name"), "library", ["document_name"], unique=True)
...
def downgrade():
    ...
    op.create_unique_constraint("library_document_name_key", "library", ["document_name"])
    # ### end Alembic commands ###
